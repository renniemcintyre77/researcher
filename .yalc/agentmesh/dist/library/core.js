...
var DataStore = class {
  ...
  isComplete(id) {
    return this.completedActions.includes(id);
  }
...
var Action = class {
  ...
  invoke(datastore) {
    if (datastore.isComplete(this.id)) {
...
var Agent = class {
  ...
  getSystemPrompt() {
    return SystemMessagePromptTemplate.fromTemplate(`
        You are a helpful AI Agent who takes on the role of ${this.role}.

        For context, your backstory is: ${this.backstory}

        Your focus is always on helping users achieve their goals.
        Your current goal is ${this.goal}
